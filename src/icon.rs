...
impl Icons {
    ...
    fn get_default_icons_by_extension() -> HashMap<&'static str, &'static str> {
        ...
        m.insert("Rhistory", "\u{f25d}"); // ""
        m.insert("rlib", "\u{e7a8}"); // ""
        m.insert("rmd", "\u{f48a}"); // ""
        m.insert("Rmd", "\u{f48a}"); // ""
        m.insert("Rproj", "\u{f25d}"); // ""
        m.insert("rs", "\u{e7a8}"); // ""
        ...
        m.insert("bed", "\u{fb82}"); // "ﮂ"
        m.insert("vcf", "\u{fb82}"); // "ﮂ"
